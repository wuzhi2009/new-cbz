...
class Monitor extends Component {
    state = { dpName:"", mediaType:1, data:[], data2:[], checkVendor:"KPY", data3:[], postStartTime:"", postEndTime:"", choose: "", delDpName: "", open:true, modifyState:"-1"} 
    componentDidMount() {
        ...
        return (
            <div style={ {position: 'relative', height: '100%'} }>
                ...
                <div style={ {position: 'absolute', left: '50%', top: 60, transform: 'translate(-50%)'} }>
                    ...
                    {data3.map((item, key) => {
                        return (
                            <div style={ {backgroundColor: '#E8ECF2', height: 24, display: 'inline-block', textAlign: 'center', padding: 5, marginLeft: 10, marginTop: 5} } key={key}>
                   ...
                   <div style={ {paddingLeft: '50%', transform: 'translate(-15%)'} }>
